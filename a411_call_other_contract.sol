...
contract CallTestContract{
    ...
    function setXAndReceiveEther(TestContract ctrtAddr, uint256 _x) external payable {

        ctrtAddr.setXAndReceiveEther{value: msg.value}(_x);
    }

    function getXAndValue(TestContract ctrtAddr) external view returns (uint256 x, uint256 value){
